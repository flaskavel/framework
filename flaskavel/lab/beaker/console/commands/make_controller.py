...
class MakeController(Command):
    ...
    def arguments(self) -> list:
        ...
        """
        return [
            ('--name', {'type': str, 'required': True, 'default': True, 'help': 'Create a controller into "Http/Controllers" folder.'})
        ]
    ...
    def handle(self) -> None:
        ...
        try:
            ...
            controllers_base_path = os.path.join(app_path(), 'Http/Controllers')
            ...
            print(f"Controller '{controller_name}' created successfully in {sub_path}")
